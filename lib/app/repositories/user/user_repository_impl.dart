    ...
    try {
      ...
      if (e.code == 'email-already-in-use') {
        ...
        if (loginTypes.contains('password')) {
          ...
          throw AuthException(message: "Você se cadastrou pelo Google, por favor utilize ele para entrar!!!");
        }
      } else {
    ...
    try {
      ...
      if (googleUser != null) {
        ...
        if (loginMethods.contains('password')) {
          throw AuthException(
              message:
                  'Você já utilizou esse e-mail para cadastro, caso tenha esquecido de sua senha por favor click em esqueci a senha');
        } else {
